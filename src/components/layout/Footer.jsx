  ...
  return (
    <footer className="bg-secondary-dark text-slate-300 py-12 no-print">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        {/* Brand */}
        <div>
          <h3 className="text-white text-lg font-heading font-bold mb-4">Tes Agribusiness Home</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li>contact@tesagribusinesshome.cm</li>
            <li>+237 678 43 19 67</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a href="https://www.facebook.com/kenanjakaoficielle" target="_blank" rel="noopener" className="hover:text-primary transition-colors"><Facebook className="w-5 h-5" /></a>
            <a href="https://wa.me/237678431967" target="_blank" rel="noopener" className="hover:text-primary transition-colors"><MessageCircle className="w-5 h-5" /></a>
          </div>
        </div>
      </div>
      <div className="border-t border-slate-700 mt-12 pt-8 text-center text-xs">
        © {new Date().getFullYear()} Tes Agribusiness Home. Tous droits réservés.
      </div>
    </footer>
  );
};
