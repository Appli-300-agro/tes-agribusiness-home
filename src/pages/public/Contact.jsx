          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-secondary">+237 678 43 19 67</p>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-secondary">contact@tesagribusinesshome.cm</p>
                <p className="text-sm text-secondary">support@tesagribusinesshome.cm</p>
              </div>
            </div>
