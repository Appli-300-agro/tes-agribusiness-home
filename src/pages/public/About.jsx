    ...
    <div className="flex flex-col gap-20 pb-20">
      ...
      <section className="bg-slate-50 py-20 border-b">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-heading font-bold text-secondary-dark mb-6">À Propos de Tes Agribusiness Home</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-secondary leading-relaxed">
              ...
              Tes Agribusiness Home s'est donné pour mission de fournir des produits alimentaires de haute qualité, sains et savoureux. 
