# Tes Agribusiness Home - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **Tes Agribusiness Home**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@tesagribusinesshome.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@tesagribusinesshome.cm` | `user123` | |
...
*   **Contact :** contact@tesagribusinesshome.cm